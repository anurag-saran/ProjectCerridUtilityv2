...
@Index("Report_ProfitandLoss_GrossProfit_pkey", ["id"], { unique: true })
@Entity("Report_ProfitandLoss_GrossProfit", { schema: "public" })
export class ReportProfitandLossGrossProfit {
